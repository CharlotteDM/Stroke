...
## This is a report about prediction of stroke. Orginal data came from Coursera Platform - "Build and deploy a stroke prediction model using R". The dataset includes information on patients such as:
